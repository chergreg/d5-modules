...
// Local Dependencies.
import { DemoCardYTModuleEditProps } from './types';
...
/**
 * Demo Card Y T Module edit component of visual builder.
 *
 * @since ??
 *
 * @param {DemoCardYTModuleEditProps} props React component props.
 *
 * @returns {ReactElement}
 */
export const DemoCardYTModuleEdit = (props: DemoCardYTModuleEditProps): ReactElement => {
  const {
    attrs,
    elements,
    id,
  ...
  return (
    ...
    >
      ...
      <div className="example_demo_card_y_t_module__inner">
        <div
          className="card-yt"
