...
// Local Dependencies.
import { DemoEtudiantModuleEditProps } from './types';
...
/**
 * Demo Etudiant Module edit component of visual builder.
 *
 * @since ??
 *
 * @param {DemoEtudiantModuleEditProps} props React component props.
 *
 * @returns {ReactElement}
 */
export const DemoEtudiantModuleEdit = (props: DemoEtudiantModuleEditProps): ReactElement => {
  const {
    attrs,
    elements,
    id,
  ...
  return (
    ...
    >
      ...
      <div className="example_demo_etudiant_module__inner">        
