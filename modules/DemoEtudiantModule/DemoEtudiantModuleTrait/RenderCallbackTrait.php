...
trait RenderCallbackTrait {
	...
	public static function render_callback( $attrs, $content, $block, $elements ) {
		...
		$html  = '<div class="example_demo_etudiant_module__inner">';
		$html .=    '<div class="example_demo_etudiant_module__image">';
		$html .=        $image;
		$html .=    '</div>';
		$html .=    '<div class="example_demo_etudiant_module__content-container">';
		$html .=        $title;
		$html .=        $description;
		$html .=    '</div>';
		$html .= '</div>'; 
