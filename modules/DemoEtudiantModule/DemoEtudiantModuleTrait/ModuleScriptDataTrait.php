<?php
/**
 * DemoEtudiantModule::module_script_data()
 *
	...
	public static function module_script_data( $args ) {
		...
		MultiViewScriptData::set(
			[
				...
				'setContent'    => [
					[
						'selector'      => $selector . ' .example_demo_etudiant_module__title',
					...
					[
						'selector'      => $selector . ' .example_demo_etudiant_module__content',
				...
				'setAttrs'      => [
					[
						'selector'      => $selector . ' .example_demo_etudiant_module__image img',
						'data'          => [
