<?php
/**
 * DemoEtudiantModule::module_styles().
 *
...
trait ModuleStylesTrait {
	...
	/**
	 * Demo Etudiant Module's style components.
	 *
	 * This function is equivalent of JS function ModuleStyles located in
	 * src/components/demo-etudiant-module/styles.tsx.
	 *
	 * @since ??
	 *
	 * @param array $args {
				...
				'styles'        => [
							...
							'styleProps' => [
								...
								'advancedStyles' => [
									[
										...
										'props'         => [
											'selector' => "{$args['orderClass']} .example_demo_etudiant_module__content-container",
					...
					CssStyle::style(
						[
							...
							'attr'      => $attrs['css'] ?? [],
							'cssFields' => DemoEtudiantModule::custom_css(),
						]
					),
