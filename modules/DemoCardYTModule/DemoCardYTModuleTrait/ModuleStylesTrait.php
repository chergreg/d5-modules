<?php
/**
 * DemoCardYTModule::module_styles().
 *
...
trait ModuleStylesTrait {
	...
	/**
	 * Demo Card Y T Module's style components.
	 *
	 * This function is equivalent of JS function ModuleStyles located in
	 * src/components/demo-card-y-t-module/styles.tsx.
	 *
	 * @since ??
	 *
	 * @param array $args {
				...
				'styles'        => [
							...
							'styleProps' => [
								...
								'advancedStyles' => [
									[
										...
										'props'         => [
											'selector' => "{$args['orderClass']} .example_demo_card_y_t_module__content-container",
					...
					CssStyle::style(
						[
							...
							'attr'      => $attrs['css'] ?? [],
							'cssFields' => DemoCardYTModule::custom_css(),
						]
					),
