<?php
/**
 * DemoCardYTModule::module_script_data()
 *
	...
	public static function module_script_data( $args ) {
		...
		MultiViewScriptData::set(
			[
				...
				'setContent'    => [
					[
						'selector'      => $selector . ' .example_demo_card_y_t_module__title',
					...
					[
						'selector'      => $selector . ' .example_demo_card_y_t_module__content',
				...
				'setAttrs'      => [
					[
						'selector'      => $selector . ' .example_demo_card_y_t_module__image img',
						'data'          => [
