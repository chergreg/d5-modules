<?php
/**
 * HelloWorldModule::module_styles().
 *
...
trait ModuleStylesTrait {
	 ...
	 * src/components/hello-world-module/styles.tsx.
	 *
	 * @since ??
	 *
	 * @param array $args {
				...
				'styles'        => [
							...
							'styleProps' => [
								...
								'advancedStyles' => [
									[
										...
										'props'         => [
											'selector' => "{$args['orderClass']} .example_hello_world_module__content-container",
					...
					CssStyle::style(
						[
							...
							'attr'      => $attrs['css'] ?? [],
							'cssFields' => HelloWorldModule::custom_css(),
						]
					),
